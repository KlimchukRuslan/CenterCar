...
@Configuration
@EnableJpaRepositories("com.centercity.server.repository")
...
public class DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        ds.setMinEvictableIdleTimeMillis(Long.valueOf(env.getRequiredProperty("db.minEvictableIdleTimeMiliss")));
